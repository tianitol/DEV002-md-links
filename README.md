...
* [3. Uso](#3-este-proyecto-consta-de-dos-partes)
* [4. Entregables](#6-entregables)
...
El objetivo de esta API/CLI es, mediante [Node.js](https://nodejs.org/), leer y analizar archivos
...
## 3. Este proyecto consta de DOS partes
